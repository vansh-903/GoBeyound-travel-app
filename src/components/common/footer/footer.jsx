      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Rawatbhata, Rajasthan, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:rawatcoder@gmail.com" className="d-block" >jkvansh109@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9876543210" className="d-block" >7339719448</a>
          </div>
        ...
        <p className="text-light">   @ 2024 First responsive react project , (Referenced) -- !Enjoyed</p> 
        </Col>
        </Row>
